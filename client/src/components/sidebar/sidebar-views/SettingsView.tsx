...
function SettingsView() {
    ...
    return (
        <div
            className="flex flex-col items-center gap-2 overflow-y-auto bg-dark p-4"
        ...
        >
            ...
            <div className="flex w-full items-end gap-2">
                ...
                <select
                    ...
                    className="rounded-md border border-darkHover bg-darkHover px-4 py-2 text-white outline-none transition-colors hover:bg-[#4a4d55] focus:border-primary focus:ring-1 focus:ring-primary"
                    title="Font Size"
                >
