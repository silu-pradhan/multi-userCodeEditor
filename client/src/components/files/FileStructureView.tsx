...
function FileStructureView() {
    ...
    return (
        <div onClick={handleClickOutside} className="flex flex-grow flex-col bg-dark overflow-hidden">
            <div className="view-title flex justify-between border-b border-darkHover">
                <h2>Files</h2>
